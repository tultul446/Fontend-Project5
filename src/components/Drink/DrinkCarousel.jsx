  ...
  return (
    <section className='mb-5 mt-5'>
     ...
     <div className='w-full lg:w-1/2 flex flex-col gap-4 p-3'>
        <h2 className='text-xl lg:text-4xl font-bold text-[#26395C] lg:w-[70%] leading-tight'>{currentSlider.heading}</h2>
         <p className='text-gray-700 lg:w-[70%] text-sm lg:text-lg'>{currentSlider.des}</p>
