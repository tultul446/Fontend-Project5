        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mx-auto  bg-inherit pb-10">
          ...
          <div className="bg-white p-2 md:p-8 mx-auto  md:mx-0 shadow-md h-auto border border-gray-400 mb-9 md:mb-0">
            ...
            <div className="space-y-1 md:space-y-4">
              <button className="w-full flex items-center justify-center md:px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-50">
              ...
              <button className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-50">
